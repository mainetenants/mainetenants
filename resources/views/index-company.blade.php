...
<div class="theme-layout">
	...
	<div class="topbar transparent">
		<div class="logo">
			<a title="" href="newsfeed.html"><img src="{{ asset('assets/images/logo2.png') }}" alt=""></a>
		</div>
				...
				<div class="row remove-ext-40">
					...
					<div class="col-lg-4 col-sm-6">
						<div class="g-post-classic">
							<figure>
								<img src="{{ asset('assets/images/resources/bloggrid-1.jpg') }}" alt="">
					...
					<div class="col-lg-4 col-sm-6">
						<div class="g-post-classic">
							<figure>
								<img src="{{ asset('assets/images/resources/bloggrid-2.jpg') }}" alt="">
					...
					<div class="col-lg-4 col-sm-6">
						<div class="g-post-classic">
							<figure>
								<img src="{{ asset('assets/images/resources/bloggrid-3.jpg') }}" alt="">
						...
						<div class="row masonry">	
									<div class="hand col-lg-3 col-sm-6">
										<div class="portfolio-box">
											<img src="{{ asset('assets/images/resources/folio-detail1.jpg') }}" alt="">
											<div class="overlinks">
												<h4><a href="portfolio-detail.html" title="">Leather Shoes</a></h4>
												<ul class="cate">
									...
									<div class="jewl col-lg-3 col-sm-6">
										<div class="portfolio-box">
											<img src="{{ asset('assets/images/resources/folio-detail2.jpg') }}" alt="">
											<div class="overlinks">
												<h4><a href="portfolio-detail.html" title="">Baby Chair</a></h4>
												<ul class="cate">
													<li><a href="#" title="">Shoes</a></li>
													<li><a href="#" title="">home made</a></li>
													<li><a href="#" title="">clothes</a></li>
									...
									<div class="accessory col-lg-3 col-sm-6">
										<div class="portfolio-box">
											<img src="{{ asset('assets/images/resources/folio-detail3.jpg') }}" alt="">
											<div class="overlinks">
									...
									<div class="diy col-lg-3 col-sm-6">
										<div class="portfolio-box">
											<img src="{{ asset('assets/images/resources/folio-detail4.jpg') }}" alt="">
											<div class="overlinks">
									...
									<div class="cloth col-lg-3 col-sm-6">
										<div class="portfolio-box">
											<img src="{{ asset('assets/images/resources/folio-detail5.jpg') }}" alt="">
											<div class="overlinks">
									...
									<div class="hand col-lg-3 col-sm-6">
										<div class="portfolio-box">
											<img src="{{ asset('assets/images/resources/folio-detail6.jpg') }}" alt="">
											<div class="overlinks">
												<h4><a href="portfolio-detail.html" title="">Winter Cap</a></h4>
												<ul class="cate">
									...
									<div class="accessory col-lg-3 col-sm-6">
										<div class="portfolio-box">
											<img src="{{ asset('assets/images/resources/folio-detail7.jpg') }}" alt="">
											<div class="overlinks">
									...
									<div class="jewl col-lg-3 col-sm-6">
										<div class="portfolio-box">
											<img src="{{ asset('assets/images/resources/folio-detail8.jpg') }}" alt="">
											<div class="overlinks">
												<h4><a href="portfolio-detail.html" title="">G-Sound Headphone</a></h4>
												<ul class="cate">
													<li><a href="#" title="">accessoires</a></li>
													<li><a href="#" title="">home made</a></li>
													<li><a href="#" title="">clothes</a></li>
				...
				<div class="row">
					...
					<div class="col-lg-3 col-sm-6">
						<div class="our-teambox">
							<figure><img src="{{ asset('assets/images/resources/team1.jpg') }}" alt=""></figure>
							<div class="team-info">
								<h4>Sara Grey</h4>
								<span>Designer</span>
							</div>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="our-teambox">
							<figure><img src="{{ asset('assets/images/resources/team2.jpg') }}" alt=""></figure>
							<div class="team-info">
								<h4>Peeter Paker</h4>
								<span>Developer</span>
							</div>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="our-teambox">
							<figure><img src="{{ asset('assets/images/resources/team3.jpg') }}" alt=""></figure>
							<div class="team-info">
								<h4>Amy watson</h4>
								<span>Support</span>
							</div>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="our-teambox">
							<figure><img src="{{ asset('assets/images/resources/team4.jpg') }}" alt=""></figure>
							<div class="team-info">
								<h4>jaison born</h4>
