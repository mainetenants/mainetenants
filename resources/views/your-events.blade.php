                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12">
                        <div class="feature-photo">
                            <div class="container-fluid">
                                ...
                                <div class="inner-container p-1 m-3">
                                    <div class="col-lg-12 col-md-12 col-sm-12 mb-1">
                                        <h4 class="text-info m-0">October 2021</h4>
                                        <hr>
                                    </div>
                                        ...
                                        <div class="card w-100 ">
                                            <div class="card-body">
                                                <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                <img class="img-thumbnail img-fluid"
                                                                    src="http://127.0.0.1:8000/assets/images/resources/admin2.jpg"
                                                                    alt="">
                                                            </div>
                                                            <div class="col-lg-8">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="Join mt-0 float-right">
                                                            <a href="#" class=""><i class="ti-more-alt"></i></a>
                                                        </div>
                                                        <div class="Join mt-0 float-right mx-3">
                                                            <a href="#" class="btn btn-sm btn-info">Join</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
