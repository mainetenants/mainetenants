					...
					<div class="col-lg-6">
						<div class="about-winku">
							...
							<figure class="sign-author">
								<img src="{{ asset('assets/images/welcome-sign.png') }}"alt=""></a>
	                         </figure>
						</div>
					</div>
					<div class="col-lg-6">
						<figure class="about-picture">
							<img src="{{ asset('assets/resources/about-comapny.jpg') }}"alt=""></a>
						</figure>
					</div>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-lg-3 col-sm-6">
						<div class="our-teambox">
							<figure><img src="{{ asset('assets/images/resources/team1.jpg') }}" alt=""></a>
								</figure>
							<div class="team-info">
								<h4>Sara Grey</h4>
								<span>Designer</span>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="our-teambox">
							<figure><img src="{{ asset('assets/resources/team4.jpg') }}"alt=""></a>
								</figure>
							<div class="team-info">
								<h4>Peeter Paker</h4>
								<span>Developer</span>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="our-teambox">
							<figure><img src="{{ asset('assets/images/resources/team3.jpg') }}" alt=""></a>
								</figure>
							<div class="team-info">
								<h4>Amy watson</h4>
								<span>Support</span>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="our-teambox">
							<figure><img src="{{ asset('assets/images/resources/team2.jpg') }}" alt=""></a>
								</figure>
							<div class="team-info">
								<h4>Emma Watson</h4>
					...
					<div class="col-lg-12">
						<div class="row">
							...
							<ul class="sponsor-logo">
								<li><img alt="" src="{{ asset('assets/images/resources/sponsor-gray1.png') }}"</li>
								<li><img alt="" src="{{ asset('assets/images/resources/sponsor-gray2.png') }}"</li>
								<li><img alt="" src="{{ asset('assets/images/resources/sponsor-gray3.png') }}"</li>
								<li><img alt="" src="{{ asset('assets/images/resources/sponsor-gray4.png') }}"</li>
								<li><img alt="" src="{{ asset('assets/images/resources/sponsor-gray5.png') }}"</li>
								<li><img alt="" src="{{ asset('assets/images/resources/sponsor-gray6.png') }}"</li>
                        	</ul>
						</div>
					</div>
				</div>
