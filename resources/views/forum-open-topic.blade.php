						...
						<div class="forum-open">
							...
							<table class="table table-responsive">
								...
								<tbody>
									<tr>
										<td class="topic-data">
											<img src="{{ asset('assets/images/resources/forum-author1.png') }}" alt="">
									...
									<tr>
										<td class="topic-data">
											<img src="{{ asset('assets/images/resources/forum-author2.png') }}" alt="">
									...
									<tr>
										<td class="topic-data">
											<img src="{{ asset('assets/images/resources/forum-author3.png') }}" alt="">
											<span>Andrew</span>
											<em>Participant</em>
										</td>
										<td class="date-n-reply">
									...
									<tr>
										<td class="topic-data">
											<img src="{{ asset('assets/images/resources/forum-author4.png') }}" alt="">
											<span>Mark Bob</span>
											<em>Participant</em>
										</td>
										<td class="date-n-reply">
