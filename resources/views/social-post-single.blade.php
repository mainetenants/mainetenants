				...
				<li>
					...
					<div class="dropdowns">
						...
						<ul class="drops-menu">
							...
							<li>
								<a href="notifications.html" title="">
									<img src="{{ asset('assets/images/resources/chatlist1.jpg') }}" alt="">
									<div class="mesg-meta">
										<h6>Amy</h6>
										<span>Hi, how r u dear ...?</span>
										<i>2 min ago</i>
								...
								<aside class="sidebar static">
									...
									<div class="widget stick-widget">
										...
										<ul class="followers">
											...
											<li>
												<figure><img src="{{ asset('assets/images/resources/friend-avatar8') }}" alt=""></figure>
												<div class="friend-meta">
												...
												<div class="post-meta">
													...
													<div class="description">
														...
														<p>
															...
															Curabitur Lonely Cat Enjoying in Summer #mypage ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, 
														</p>
													</div>
												</div>
											</div>
