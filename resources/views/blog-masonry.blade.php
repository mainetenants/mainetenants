						...
						<div class="blog-sec">
							...
							<div class="row masonry">
								...
								<div class="col-lg-4 col-sm-6">
									<div class="g-post-classic">
										<figure>
											<img src="{{ asset('assets/images/resources/bloggrid-mas-1.jpg') }}" alt="">
								...
								<div class="col-lg-4 col-sm-6">
									<div class="g-post-classic">
										<figure>
											<img src="{{ asset('assets/images/resources/bloggrid-4.jpg') }}" alt="">
											<i class="fa fa-video-camera"></i>
										</figure>
										<div class="g-post-meta">
											<div class="post-title">
								...
								<div class="col-lg-4 col-sm-6">
									<div class="g-post-classic">
										<figure>
											<img src="{{ asset('assets/images/resources/bloggrid-mas-2.jpg') }}" alt="">
											<i class="fa fa-soundcloud"></i>
										</figure>
										<div class="g-post-meta">
											<div class="post-title">
								...
								<div class="col-lg-4 col-sm-6">
									<div class="g-post-classic">
										<figure>
											<img src="{{ asset('assets/images/resources/bloggrid-6.jpg') }}" alt="">
											<i class="fa fa-image"></i>
										</figure>
										<div class="g-post-meta">
											<div class="post-title">
								...
								<div class="col-lg-4 col-sm-6">
									<div class="g-post-classic">
										<figure>
											<img src="{{ asset('assets/images/resources/bloggrid-mas-3.jpg') }}" alt="">
											<i class="fa fa-image"></i>
										</figure>
										<div class="g-post-meta">
											<div class="post-title">
								...
								<div class="col-lg-4 col-sm-6">
									<div class="g-post-classic">
										<figure>
											<img src="{{ asset('assets/images/resources/bloggrid-5.jpg') }}" alt="">
											<i class="fa fa-image"></i>
										</figure>
										<div class="g-post-meta">
											<div class="post-title">
					...
					<div class="col-lg-12">
						<div class="btm-baner">
							<div class="baner-mockup">
								<img src="{{ asset('assets/images/resources/btm-baner-avatar.png') }}" alt="">
							</div>
							<div class="baner-inf">
		...
		<div class="row">
			<div class="col-lg-4 col-md-4">
				<div class="widget">
					<div class="foot-logo">
						<div class="logo">
							<a href="index.html" title=""><img src="{{ asset('assets/images/logo.png') }}" alt="">
					      </a>
						</div>	
						<p>
