				...
				<li>
					...
					<div class="dropdowns">
						...
						<ul class="drops-menu">
							...
							<li>
								<a href="notifications.html" title=""><img src="{{ asset('assets/images/resources/thumb-5.jpg') }}" alt="">
									<div class="mesg-meta">
										<h6>Amy</h6>
										<span>Hi, how r u dear ...?</span>
										<i>2 min ago</i>
								...
								<div class="col-lg-3">
									<aside class="sidebar static">
										...
										<div class="widget stick-widget">
											...
											<ul class="followers">
												<li>
													<figure><img src="{{ asset('assets/images/resources/friend-avatar.jpg') }}" alt="">
														</figure>
