					...
					<div class="offset-lg-1 col-lg-10">
						<div class="detail-page">
							<div class="detail-top">
								<img src="{{ asset('assets/images/resources/blog-detailfull.jpg') }}" alt="">
							...
							<div class="detail-meta">
								...
								<div class="post-time">
									<div class="author-thumb">
										<img src="{{ asset('assets/images/resources/chatlist2.jpg') }}" alt="">
								...
								<figure class="alignright">
									<img src="{{ asset('assets/images/resources/blog-detail2.jpg') }}" alt="">
								</figure>
								<p>
								...
								<div class="gap-60">
									<div class="site-admin">
										<div class="admin-avatar">
											<img src="{{ asset('assets/images/resources/admin4.jpg') }}" alt="">
										</div>
											...
											<li>
												<div class="comment-box">
													<div class="commenter-photo">
														<img src="{{ asset('assets/images/resources/commenter-1.jpg') }}" alt="">
													</div>
	...
	pulvinar eu aliquet nibh dapibus.
												...
												<ul>
													<li>
														<div class="comment-box">
															<div class="commenter-photo">
																<img src="{{ asset('assets/images/resources/commenter-2.jpg') }}" alt="">
															</div>
															<div class="commenter-meta">
																<div class="comment-titles">
																	<h6>Qlark Jack</h6>
		...
		pulvinar eu aliquet nibh dapibus.
											...
											<li>
												<div class="comment-box">
													<div class="commenter-photo">
														<img src="{{ asset('assets/images/resources/commenter-3.jpg') }}" alt="">
