				...
				<div class="row" id="page-contents">
					<div class="col-lg-12">
						<div class="blog-sec">
							...
							<div class="l-post">
								<figure>
									<img src="{{ asset('assets/images/resources/bloglist-1.jpg') }}" alt="">
							...
							<div class="l-post">
								<figure>
									<img src="{{ asset('assets/images/resources/bloglist-2.jpg') }}" alt="">
									<ul class="blg-socials">
										<li><a href="#" title="" class="facebook"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#" title="" class="twitter"><i class="fa fa-twitter"></i></a></li>
										<li><a href="#" title="" class="pinterest"><i class="fa fa-pinterest"></i></a></li>
							...
							<div class="l-post">
								<figure>
									<img src="{{ asset('assets/images/resources/bloglist-3.jpg') }}" alt="">
									<ul class="blg-socials">
										<li><a href="#" title="" class="facebook"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#" title="" class="twitter"><i class="fa fa-twitter"></i></a></li>
										<li><a href="#" title="" class="pinterest"><i class="fa fa-pinterest"></i></a></li>
							...
							<div class="l-post">
								<figure>
									<img src="{{ asset('assets/images/resources/bloglist-4.jpg') }}" alt="">
									<ul class="blg-socials">
										<li><a href="#" title="" class="facebook"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#" title="" class="twitter"><i class="fa fa-twitter"></i></a></li>
										<li><a href="#" title="" class="pinterest"><i class="fa fa-pinterest"></i></a></li>
