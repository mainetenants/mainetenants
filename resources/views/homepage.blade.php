                                    ...
                                    <div class="newpst-input">
                                        ...
                                        <form method="post" id="upload_files" action="get-post-list"
                                            ...
                                            <p class="lead emoji-picker-container">
                                                ...
                                                <textarea rows="2" placeholder="write something" name="msg"
                                            ...
                                            <div class="attachments">
                                                <ul>
                                                    ...
                                                    <li class="text-secondary">
                                                        <input type="submit" class="btn btn-info btn-sm" id="posts"
                                                            value="Post">
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="post-meta">
                                            ...
                                            <div class="we-video-info">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <span class="comment text-secondary" data-toggle="tooltip"
                                                            title="Comments">
                                                    ...
                                                    <li class="social-media">
                                                        <div class="menu">
                                                            <div class="btn trigger"><i
                                                                    class="fa fa-share-alt text-secondary"></i></div>
                                                            <div class="rotater">
                                                                <div class="btn btn-icon"><a href="#"
                                                                        class="text-secondary"" title=""><i class=" fa
                                                                        fa-html5 text-secondary"></i></a></div>
                                                            </div>
                                                            <div class="rotater">
                                                                <div class="btn btn-icon"><a href="#"
                                                                        class="text-secondary"" title=""><i class=" fa
                                                                        fa-facebook text-secondary"></i></a></div>
                                                            </div>
                                                            <div class="rotater">
                                                                <div class="btn btn-icon"><a href="#"
                                                                        class="text-secondary"" title=""><i class=" fa
                                                                        fa-google-plus text-secondary"></i></a></div>
                                                            </div>
                                                            <div class="rotater">
                                                                <div class="btn btn-icon"><a href="#"
                                                                        class="text-secondary"" title=""><i class=" fa
                                                                        fa-twitter text-secondary"></i></a></div>
                                                            </div>
                                                            <div class="rotater">
                                                                <div class="btn btn-icon"><a href="#"
                                                                        class="text-secondary"" title=""><i class=" fa
                                                                        fa-css3 text-secondary"></i></a></div>
                                                            </div>
                                                            <div class="rotater">
                                                                <div class="btn btn-icon"><a href="#"
                                                                        class="text-secondary"" title=""><i class=" fa
                                                                        fa-instagram text-secondary"></i></a>
                                                                </div>
                                                            </div>
                                                            <div class="rotater">
                                                                <div class="btn btn-icon"><a href="#"
                                                                        class="text-secondary"" title=""><i class=" fa
                                                                        fa-dribbble text-secondary"></i></a>
                                                                </div>
                                                            </div>
                                                            <div class="rotater">
                                                                <div class="btn btn-icon"><a href="#"
                                                                        class="text-secondary"" title=""><i class=" fa
                                                                        fa-pinterest text-secondary"></i></a>
                                                                </div>
                                                            </div>
                                            ...
                                            <li>
                                                ...
                                                <div class="we-comment">
                                                    <div class="coment-head">
                                                        <h5><a href="time-line" title="">@php echo
                                                                get_user_nane1($comment->user_id) @endphp</a></h5>

                                                        @if( $is_like == 1)<a class="like"
                                                            onclick="dislike_post_cmt({{ $comment->id }},{{ $comment->post_id }})"
                                                            href="#"><i class="fa fa-thumbs-up" style="color:#088dcd;"
                                                                aria-hidden="true"></i> </a>@else<a class="like"
                                                            onclick="like_post_cmt({{ $comment->id }},{{ $comment->post_id }})"
                                                            href="#"><i class="fa fa-thumbs-up  icon-color"
                                                                aria-hidden="true"></i></a> @endif
                                                        <a class="we-reply1" href="#" onclick="return false"
                                                            data-id="{{ $comment->id }}"
                                                            post-id="{{ $comment->post_id }}" id="we-reply"
                                                            title="Reply"><i class="fa fa-reply"></i></a>
                                                        @if($comment->user_id == $user_id)
                                                        <a class="delete" href="#"
                                                            onclick="delete_post_comment({{ $comment->id }})"><i
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="we-comment">
                                                            <div class="coment-head">
                                                                ...
                                                                <h5><a href="time-line" title="">@php echo
                                                                        get_user_nane1($inner_cmt->user_id) @endphp</a>
                                                                </h5>
                                                                <span>{{ $inner_cmt->created }}</span>
                                                                {{-- @if($is_like_inner == 1)<a class="like"  onclick="dislike_post_inner_cmt({{ $inner_cmt->id }},{{ $inner_cmt->post_id }})"
                                                                href="#" ><i class="fa fa-thumbs-up"
                                                                    style="color:#088dcd;" aria-hidden="true"></i>
                                                                </a>@else<a class="like"
                                                                    onclick="like_post_inner_cmt({{ $inner_cmt->id }},{{ $inner_cmt->post_id }})"
                                                                    href="#"><i class="fa fa-thumbs-up  icon-color"
                                                                        aria-hidden="true"></i></a> @endif --}}
                                                                <a class="we-reply" href="#" onclick="return false"
                                                                    data-id="{{ $inner_cmt->id }}" id="we-reply"
                                                                    title="Reply"><i class="fa fa-reply"></i></a>

                                                                @if($inner_cmt->user_id == $user_id)
                                                                <a class="delete" href="#"
                                                                    onclick="delete_comment({{ $inner_cmt->id }})"><i
                                                                        class="fa fa-trash text-danger"
                                                                        aria-hidden="true"></i></a>
                          ...
                          @endphp --}}
                                            <div class="post-comt-box">
                                                <form method="post" id="page_post_comments"
                                                    enctype="multipart/form-data" action="{{url("homepage")}}">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-sm-11">
                                                            <textarea placeholder="Post your comment" id="commen_1234"
                                                                class="comment_1243" name="comment"></textarea>
                                                        </div>
                                                        <div class="col-sm-1">
                                                    ...
                                                    <div class="modal-header pb-0">
                                                        <ul class="nav nav-tabs" role="tablist">
                                                            <li class="nav-link active" role="presentation"
                                                                class="active"><a href="#all" class="tab-a" role="tab"
                                                                    data-toggle="tab">All</a>
                                                            </li>
                                                            <li class="nav-link" role="presentation"><a href="#like"
                                                                    class="tab-a" role="tab" data-toggle="tab"><img
                                                                        src="/assets/images/s_emoji/like.png"
                                                                        class="img-reaction" /><ins
                                                                        class="ins_like"></ins></a>
                                                            </li>
                                                            <li class="nav-link" role="presentation"><a href="#love"
                                                                    class="tab-a" role="tab" data-toggle="tab"><img
                                                                        src="/assets/images/s_emoji/love.png"
                                                                        class="img-reaction" /><ins
                                                                        class="ins_love"></ins></a>
                                                            </li>
                                                            <li class="nav-link" role="presentation"><a href="#haha"
                                                                    class="tab-a" role="tab" data-toggle="tab"><img
                                                                        src="/assets/images/s_emoji/haha.png"
                                                                        class="img-reaction" /><ins
                                                                        class="ins_haha"></ins></a>
                                                            </li>
                                                            <li class="nav-link" role="presentation"><a href="#sad"
                                                                    class="tab-a" role="tab" data-toggle="tab"><img
                                                                        src="/assets/images/s_emoji/sad.png"
                                                                        class="img-reaction" /><ins
                                                                        class="ins_sad"></ins></a>
                                                            </li>
                                                            <li class="nav-link" role="presentation"><a href="#angry"
                                                                    class="tab-a" role="tab" data-toggle="tab"><img
                                                                        src="/assets/images/s_emoji/angry.png"
                                                                        class="img-reaction" /><ins
                                                                        class="ins_angry"></ins></a>
                                                            </li>
                                                            <li class="nav-link" role="presentation"><a href="#care"
                                                                    class="tab-a" role="tab" data-toggle="tab"><img
                                                                        src="/assets/images/s_emoji/care.png"
                                                                        class="img-reaction" /><ins
                                                                        class="ins_care"></ins></a>
                                                            </li>
                                                            <li class="nav-link" role="presentation"><a href="#wow"
                                                                    class="tab-a" role="tab" data-toggle="tab"><img
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="tab-content">
                                                            <div role="tabpanel" class="tab-pane active allfrnd"
                                                                id="all"></div>
                                                            <div role="tabpanel" class="tab-pane like_rc" id="like">
                                                            </div>
                                                            <div role="tabpanel" class="tab-pane sad_rc" id="sad"></div>
                                                            <div role="tabpanel" class="tab-pane love_rc" id="love">
                                                            </div>
                                                            <div role="tabpanel" class="tab-pane haha_rc" id="haha">
                                                            </div>
                                                            <div role="tabpanel" class="tab-pane angry_rc" id="angry">
                                                            </div>
                                                            <div role="tabpanel" class="tab-pane care_rc" id="care">
                                                            </div>
                            ...
                            <div class="central-meta item bg-white bg-light">
                                ...
                                <div class="coment-area bg-white bg-light">
                                    <ul class="we-comet">
                                        ...
                                        <div class="post-comt-box">
                                            <form method="post" id="page_post_comments" enctype="multipart/form-data"
                                                action="{{url("homepage")}}">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-sm-11">
                                    ...
                                    <div class="modal fade" id="editpost" tabindex="-1" aria-hidden="false">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" id="edit_form" action="{{ url("edit-post"); }}"
                                                        enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="container">
                                                            <div class="row">
                                    ...
                                    <div class="modal fade" id="reaction" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-md" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header pb-0">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        <li class="nav-link active" role="presentation" class="active">
                                                            <a href="#all" class="tab-a" role="tab"
                                                                data-toggle="tab">All</a>
                                                        </li>
                                                        <li class="nav-link" role="presentation"><a href="#like"
                                                                class="tab-a" role="tab" data-toggle="tab"><img
                                                ...
                                                <div class="modal-body">
                                                    <div class="tab-content">
                                                        <div role="tabpanel" class="tab-pane active allfrnd" id="all">
                                                        </div>
