                            ...
                            <div class="container-fluid">
                                ...
                                <form id="event" method="POST" enctype="multipart/form-data" action="{{ url('create-event-form') }}">
                                    ...
                                    <div class="col-md-12 text-center p-0 mt-3 mb-2">
                                        <div class="mt-3 mb-3">
                                            <div class="probress-btns col-md-8 offset-md-2" style="display: none123">
                                                <ul id="progressbar">
                                            ...
                                            <div class="container event-type" style="display: none123">
                                                <div class="row mt-5 ">
                                                    <div class="col-sm-6">
                                                        <div class="card">
                                                            <label for="general">
                                    ...
                                    <div class="event-details col-md-8 offset-md-2 bg-light mt-2 p-4"
                                        ...
                                        <div class="p-3">
                                            ...
                                            <div class="mb3 guest-box" style="display:none123">
                                                <div class="form-check">
                                    ...
                                    <div class="locations col-md-8 offset-md-2 bg-light mt-2 p-4" style="display:none123">
                                        ...
                                        <div class="p-3">
                                            ...
                                            <div class="mb-3 mt-3 event_link" style="display: none123">
