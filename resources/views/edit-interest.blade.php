...
<div class="theme-layout">
	...
	<section>
			<div class="feature-photo">
				<figure><img src="{{ asset('assets/images/resources/timeline-1.jpg') }}" alt="">
					</figure>
				<div class="add-btn">
					...
					<div class="row merged">
						<div class="col-lg-2 col-sm-3">
							<div class="user-avatar">
								<figure><img src="{{ asset('assets/images/resources/uses-avatar.jpg') }}" alt="">
									<form class="edit-phto">
										<i class="fa fa-camera-retro"></i>
										<label class="fileContainer">
											Edit Display Photo
								...
								<div class="col-lg-6">
									<div class="central-meta">
										<div class="editing-interest">
											...
											<form method="post" action="{{ url('/edit-interest') }}">
												@csrf
												<label>Add interests: </label>
												<input type="text" name="interest">
												<button type="submit">Add</button>
												<div class="submit-btns">
													<button type="submit" class="mtr-btn"><span>Cancel</span></button>
