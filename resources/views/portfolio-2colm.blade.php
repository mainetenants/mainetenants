						...
						<div class="row masonry">	
							<div class="hand col-lg-6 col-sm-6">
								<div class="portfolio-box">
									<img src="{{ asset('assets/images/resources/folio-detail-big1.jpg') }}" alt="">
									
									<div class="overlinks">
										<h4><a href="portfolio-detail.html" title="">Ladies Shoes</a></h4>
										<ul class="cate">
							...
							<div class="jewl col-lg-6 col-sm-6">
								<div class="portfolio-box">
									<img src="{{ asset('assets/images/resources/folio-detail-big2.jpg') }}" alt="">
									<div class="overlinks">
										<h4><a href="portfolio-detail.html" title="">Summer Bottle</a></h4>
										<ul class="cate">
											<li><a href="#" title="">accessoires</a></li>
											<li><a href="#" title="">home made</a></li>
											<li><a href="#" title="">clothes</a></li>
							...
							<div class="accessory col-lg-6 col-sm-6">
								<div class="portfolio-box">
									<img src="{{ asset('assets/images/resources/folio-detail-big3.jpg') }}" alt="">
									<div class="overlinks">
										<h4><a href="portfolio-detail.html" title="">Stylish exe</a></h4>
										<ul class="cate">
											<li><a href="#" title="">accessoires</a></li>
											<li><a href="#" title="">home made</a></li>
											<li><a href="#" title="">clothes</a></li>
							...
							<div class="diy col-lg-6 col-sm-6">
								<div class="portfolio-box">
									<img src="{{ asset('assets/images/resources/folio-detail-big4.jpg') }}" alt="">
									<div class="overlinks">
										<h4><a href="portfolio-detail.html" title="">Shoes Official</a></h4>
										<ul class="cate">
											<li><a href="#" title="">accessoires</a></li>
											<li><a href="#" title="">home made</a></li>
											<li><a href="#" title="">clothes</a></li>
							...
							<div class="cloth col-lg-6 col-sm-6">
								<div class="portfolio-box">
									<img src="{{ asset('assets/images/resources/folio-detail-big5.jpg') }}" alt="">
									<div class="overlinks">
										<h4><a href="portfolio-detail.html" title="">Nike Bags</a></h4>
										<ul class="cate">
											<li><a href="#" title="">accessoires</a></li>
											<li><a href="#" title="">home made</a></li>
											<li><a href="#" title="">clothes</a></li>
							...
							<div class="hand col-lg-6 col-sm-6">
								<div class="portfolio-box">
									<img src="{{ asset('assets/images/resources/folio-detail-big6.jpg') }}" alt="">
									<div class="overlinks">
										<h4><a href="portfolio-detail.html" title="">Sigar Brand</a></h4>
										<ul class="cate">
											<li><a href="#" title="">accessoires</a></li>
											<li><a href="#" title="">home made</a></li>
											<li><a href="#" title="">clothes</a></li>
