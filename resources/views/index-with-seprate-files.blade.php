...
<head>
	...
	<link rel="stylesheet" href="css/responsive-mhead.css">
...
<div class="theme-layout">
										...
										<div class="friend-info">
											...
											<div class="post-meta">
												<div class="linked-image align-left">
													<a title="" href="#"><img src="{{ asset('assets/images/resources/page1.jpg') }}" alt="">
                                                   </a>
												</div>
												<div class="detail">
								...
								<aside class="sidebar static">
													...
													<span><i class="ti-heart"></i>884</span>
													  ...
													  <div class="users-thumb-list">
														<a href="#" title="Anderw" data-toggle="tooltip">
															<img src="{{ asset('assets/images/resources/userlist-1.jpg') }}" alt=""></a>
														<a href="#" title="frank" data-toggle="tooltip">
															<img src="{{ asset('assets/images/resources/userlist-2.jpg') }}" alt=""></a>
														<a href="#" title="Sara" data-toggle="tooltip">
															<img src="{{ asset('assets/images/resources/userlist-3.jpg') }}" alt=""></a>													
														<a href="#" title="Amy" data-toggle="tooltip">
															<img src="{{ asset('assets/images/resources/userlist-4.jpg') }}" alt=""></a>													
														<a href="#" title="Ema" data-toggle="tooltip">
															<img src="{{ asset('assets/images/resources/userlist-5.jpg') }}" alt=""></a>												
														<a href="#" title="Sophie" data-toggle="tooltip">
															<img src="{{ asset('assets/images/resources/userlist-6.jpg') }}" alt=""></a>													
														<a href="#" title="Maria" data-toggle="tooltip">
															<img src="{{ asset('assets/images/resources/userlist-7.jpg') }}" alt=""></a>													 
													  </div>
												  </div>
									...
									<div class="widget">
										<div class="banner medium-opacity bluesh">
											...
											<div class="baner-top">
												<span><img src="{{ asset('assets/images/book-icon.png') }}" alt="">
													</span>
	...
	<script src="js/responsive-mhead.js"></script>
