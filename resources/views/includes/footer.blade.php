...
<script src="https://cdn.tiny.cloud/1/no-api/tinymce/5/tinymce.min.js"
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.allReaction) {
                    ...
                    var count = [count_like_rc, count_love_rc, count_haha_rc, count_angry_rc,
                        count_care_rc, count_wow_rc, count_sad_rc
                    ];
