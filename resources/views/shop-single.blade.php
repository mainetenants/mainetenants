								...
								<div class="col-lg-6">
									<div class="prod-avatar">
										<ul class="slider-for-gold">
											 <li><img src="{{ asset('assets/images/resources/detail-gold1.jpg') }}" alt=""></li>
											 <li><img src="{{ asset('assets/images/resources/detail-gold2.jpg') }}" alt=""></li>
											 <li><img src="{{ asset('assets/images/resources/detail-gold3.jpg') }}" alt=""></li>
											 <li><img src="{{ asset('assets/images/resources/detail-gold1.jpg') }}" alt=""></li>
										</ul>
													...
													<ol class="commentlist">
														<li>
															<div class="comment_container">
																<img src="{{ asset('assets/images/resources/single-comment1.jpg') }}" alt="" class="avatar">
									...
									<div class="col-lg-3 col-sm-6">
										<div class="product-box">
											<figure>
												...
												<img src="{{ asset('assets/images/resources/shop2.jpg') }}" alt="">
												<ul class="cart-optionz">
													<li><a href="#" title="Add Cart" data-toggle="tooltip"><i class="ti-shopping-cart"></i></a></li>
													<li><a href="#" title="Quick Shop" data-toggle="tooltip"><i class="ti-eye"></i></a></li>
													<li><a href="#" title="Wishlist" data-toggle="tooltip"><i class="ti-heart"></i></a></li>
