...
<div class="theme-layout">
	...
	<div class="topbar stick">
		<div class="logo">
			<a title="" href="newsfeed.html"><img src="{{ asset('assets/images/logo.png') }}" alt="">
		</div>
			...
			<ul class="setting-area">
				...
				<li>
					...
					<div class="dropdowns">
						...
						<ul class="drops-menu">
							<li>
								<a href="notifications.html" title=""><img src="{{ asset('assets/images/resources/thumb-1.jpg') }}" alt="">
									<div class="mesg-meta">
										<h6>sarah Loren</h6>
							...
							<li>
								<a href="notifications.html" title=""><img src="{{ asset('assets/images/resources/thumb-2.jpg') }}" alt="">
									<div class="mesg-meta">
										<h6>Jhon doe</h6>
										<span>Hi, how r u dear ...?</span>
										<i>2 min ago</i>
							...
							<li>
								<a href="notifications.html" title=""><img src="{{ asset('assets/images/resources/thumb-3.jpg') }}" alt="">
									<div class="mesg-meta">
										<h6>Andrew</h6>
										<span>Hi, how r u dear ...?</span>
										<i>2 min ago</i>
							...
							<li>
								<a href="notifications.html" title=""><img src="{{ asset('assets/images/resources/thumb-4.jpg') }}" alt="">
									<div class="mesg-meta">
										<h6>Tom cruse</h6>
										<span>Hi, how r u dear ...?</span>
										<i>2 min ago</i>
		...
		<div class="chat-friendz">
			...
			<div class="chat-box">
				...
				<div class="chat-list">
					<ul>
						<li class="me">
							<div class="chat-thumb"><img src="{{ asset('assets/images/resources/chatlist1.jpg') }}" alt="">
						...
						<li class="you">
							<div class="chat-thumb"><img src="{{ asset('assets/images/resources/chatlist2.jpg') }}" alt="">
							<div class="notification-event">
								<span class="chat-message-item">
									Hi James! Please remember to buy the food for tomorrow! I’m gonna be handling the gifts and Jake’s gonna get the drinks
								</span>
										...
										<div class="friend-info">
											...
											<div class="post-meta">
												<div class="linked-image align-left">
													<a title="" href="#"><img src="{{ asset('assets/images/resources/page1.jpg') }}" alt=""></a>
												</div>
												<div class="detail">
